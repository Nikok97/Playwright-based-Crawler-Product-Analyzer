...
class BooksToScrape(WebsiteToScrape):
    ...
    def __init__(self):
        ...
        # Seed URL
        self.seed_urls = ["https://books.toscrape.com/"]
        self.base_url = "https://books.toscrape.com/catalogue/"
        
        # Required selectors for scraping
        self.selector_to_start_process = "div.product_price"
        self.wait_selector = "p.price_color"
        self.product_pod_selector = ("article", "product_pod")
        self.price_selector = ("p", "price_color")
        self.currency_selector = ("span", "a-price-symbol")
        self.product_link_selector = "a"
        
        # Required selectors for individual product pages
        self.individual_product_name_selector = "h1"
        self.price_selector = ("p", "price_color")
        self.product_id_selector = "td"
    ...
    def product_extraction(self, soup: Tag) -> list[dict] | None:
        ...
        # Finds in the downloaded HTML file all the tags that have this selector
        container = soup.find_all(self.product_pod_selector[0], 
        class_=self.product_pod_selector[1]
        )
        ...
        for product_pod in container:

            # Price and name extraction
            # Initialize variables
            link = None

            # Link extracion
            link = product_pod.find(self.product_link_selector)
    ...
    # Individual product parsing function
...
class MercadoLibre(WebsiteToScrape):
    """
    ...
    def __init__(self):
        ...
        # Seed_URL (should lead to search results)
        self.seed_urls = [
            "https://listado.mercadolibre.com.ar/guitarra-usada"
        ]
