...
from playwright.sync_api import Browser, BrowserContext, ViewportSize, Page

def stealth_context(browser: Browser) -> BrowserContext:

    ua = random.choice([
        # Desktop Chrome-like UAs (user agents)
...
def human_scroll(page: Page, min_increment=200, max_increment=450,  timeout=15.0) -> None:
